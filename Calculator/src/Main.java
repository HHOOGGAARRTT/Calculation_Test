    ...
    public static void main(String[] args) {
        ...
        if (calculation.isEmpty())
        {
            try {
                ...
                System.out.println("Просьба внести данные");
                System.exit(0);
            }
        }
        ...
        if (romearabic1 != romearabic2) {
            ...
            System.out.println("Укажи только одну систему счисления");
            System.exit(0);
            }
        }
       ...
       // int arabicNumber11 = arabicNumber1;
        ...
        if ((arabicNumber1 < 0 || arabicNumber1 > 10) || (arabicNumber2 < 0 || arabicNumber2 > 10))
        {
            try {
                ...
                System.out.println("Просьба указать числа от 1 до 10 или от I до X");
                System.exit(0);
            }
        }
        int answ = 0;
        ...
        if (romearabic1 == 2 && answ < 1){
            try {
                ...
                System.out.println("В Римской системе нет нуля и отрицательных цисел");
                System.exit(0);
            }
        }
...
//            int index1 = 0;
            ...
            System.out.println("Ответ: "+romanAnswer);
        }
        else {
